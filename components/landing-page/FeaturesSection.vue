        ...
        <div class="mb-10 lg:mb-0 lg:col-span-6 lg:col-start-8 lg:order-2">
          ...
          <nav class="grid gap-4 mt-5 md:mt-10" aria-label="Tabs" role="tablist" aria-orientation="vertical">
            ...
            <span class="flex gap-x-6">
              ...
              <span class="grow">
                <span class="block text-lg font-semibold hs-tab-active:text-blue-600 text-gray-800 dark:hs-tab-active:text-blue-500 dark:text-neutral-200">Tertib Administrasi</span>
                <span class="block mt-1 text-gray-800 dark:hs-tab-active:text-gray-200 dark:text-neutral-200">Semua data warga tersimpan aman dan terstruktur.</span>
              </span>
            </span>
            </button>
            ...
            <span class="flex gap-x-6">
              ...
              <span class="grow">
                <span class="block text-lg font-semibold hs-tab-active:text-blue-600 text-gray-800 dark:hs-tab-active:text-blue-500 dark:text-neutral-200">Atur Kegiatan & Jadwal</span>
                <span class="block mt-1 text-gray-800 dark:hs-tab-active:text-gray-200 dark:text-neutral-200">Buat dan pantau kegiatan warga, rapat RT, jadwal ronda, atau pengajian tanpa perlu grup WhatsApp yang berantakan.</span>
              </span>
            </span>
            </button>
            ...
            <span class="flex gap-x-6">
              ...
              <span class="grow">
                <span class="block text-lg font-semibold hs-tab-active:text-blue-600 text-gray-800 dark:hs-tab-active:text-blue-500 dark:text-neutral-200">Pengurus Lebih Produktif</span>
                <span class="block mt-1 text-gray-800 dark:hs-tab-active:text-gray-200 dark:text-neutral-200">Pengurus RT/RW punya dashboard khusus untuk memantau laporan, persetujuan, hingga surat menyurat digital.</span>
              </span>
            </span>
            </button>
          </nav>
