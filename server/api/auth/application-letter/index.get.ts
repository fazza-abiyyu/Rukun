...
export default defineEventHandler(async (event) => {
    try {
        ...
        const application_leter = await ApplicationLetter.getAllApplicationLetters(page, pagesize);

        // Hitung total halaman
        const totalApplicationLeter = await ApplicationLetter.countAllApplicationLetters();
